...
and vector for first hypothesis.
Return: Number of time steps to converge, final hypothesis.
"""
def pla(points, bools, w):
    t_converge = 0
    while(True):
        check = False
        for count, point in enumerate(points):
